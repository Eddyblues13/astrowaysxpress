			...
			<table>
				<tr>
					<td style="font-size:9pt;text-align:center;">
						<a class="" href="{{route('home')}}" style="margin-right:10px">
							<img src="{{asset('user/icon/dashboard.png')}}"
								style="width:20px;height:20px"><br>Dashboard</a>
					</td>
					<td style="font-size:9pt;text-align:center;">
						<a class="" href="{{route('admin.packages.create')}}" style="margin-right:10px">
							<img src="{{asset('user/icon/Copy Trader.png')}}" style="width:20px;height:20px"><br> Create
							a New Package
						</a>
					</td>

					<td style="font-size:9pt;text-align:center;"> <a class="" href="{{route('admin.packages')}}"
							style="margin-right:10px">
							<img src="{{asset('user/icon/history.png')}}" style="width:20px;height:20px"><br>
							View Package</a>
					</td>
					<td style="font-size:9pt;text-align:center;">
